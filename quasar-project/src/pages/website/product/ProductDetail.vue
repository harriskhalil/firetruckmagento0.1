        ...
        <div class="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
          ...
          <form class="mt-6">
            ...
            <div class="mt-10 flex sm:flex-col1">
              <button type="submit" @click="ChangeRoute('/website/checkout')" class="max-w-xs flex-1 bg-indigo-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500 sm:w-full">Add to bag</button>
...
export default defineComponent({
  name: 'ProductDetail',
  components:{Disclosure, DisclosureButton, DisclosurePanel, RadioGroup, RadioGroupLabel, RadioGroupOption, Tab, TabGroup, TabList, TabPanel, TabPanels,StarIcon,HeartIcon, MinusSmIcon, PlusSmIcon},
  data(){
    return{
      product:{
      ...
      // selectedColor:ref(this.product)
      selectedColor:ref(true)
